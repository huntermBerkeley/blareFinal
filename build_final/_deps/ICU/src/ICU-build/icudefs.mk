...
prefix = /home/hunter/Blare/build/_deps/ICU-build
exec_prefix = ${prefix}
...
SO_TARGET_VERSION = 72.1
SO_TARGET_VERSION_MAJOR = 72
...
ICUDATA_BASENAME_VERSION = $(ICUPREFIX)dt72
# the entry point is almost like the basename, but has the lib suffix.  
ICUDATA_ENTRY_POINT = $(ICUPREFIX)dt72 
ICUDATA_CHAR = l
...
CFLAGS = -O3  -std=c11 -Wall -pedantic -Wshadow -Wpointer-arith -Wmissing-prototypes -Wwrite-strings $(THREADSCFLAGS) 
